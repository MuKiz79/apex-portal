...
- ✅ **Mentor-Katalog** - Filtering nach Industrie, Detail-Ansichten
- ✅ **Dashboard** - Profilbild-Upload, Bestellübersicht, Terminverwaltung
- ✅ **Verfügbarkeits-Kalender** - Kunden geben nach Bestellung ihre Wunschtermine an
- ✅ **Terminbuchung** - Für gebuchte Mentoring-Sessions
...
└── js/
    ├── core.js        # Firebase, Utils, Navigation (208 Zeilen)
    └── app.js         # Features, Auth, Cart, Dashboard (828 Zeilen)
```
...
- `orders` - Bestellungen
- `availability` - Kunden-Verfügbarkeit für Termine
- `settings` - App-Einstellungen (z.B. "Über uns" Bild)
- `coaches` - Mentor-Profile (optional)
...
© 2024 APEX Executive. Alle Rechte vorbehalten.
